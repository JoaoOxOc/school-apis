namespace Utils.Constants
{
    public static class RabbitMQCredentials
    {
        ...
        public static string HostName = "172.22.0.2"; //docker school_bridge network - use command: docker inspect school_bridge, if unavailable, use command: docker network connect school_bridge rabbit-docker
